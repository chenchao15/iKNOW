  ...
  methods: {
    links () {
      ...
      if (this.type === '0') {
        ...
        this.$http.get(this.GLOBAL.baseUrl + 'api/tutorial/offical_tutorial?type=1')
          .then((response) => {
            var res0 = JSON.parse(response.bodyText)
            this.tutorials = res0
          }).catch((response) => {
        ...
        this.$http.get(this.GLOBAL.baseUrl + 'api/tutorial/offical_tutorial?type=2')
          .then((response) => {
            var res0 = JSON.parse(response.bodyText)
            this.tutorials = res0
          }).catch((response) => {
