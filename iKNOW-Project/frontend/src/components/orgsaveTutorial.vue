  ...
  <div class="collectTutorial">
    <Row v-for="tutorial in tutorials" :key="tutorial.id">
      <Card style="margin-top:25px;width:600px;height:150px;" @click="checkAllTutorial">
        ...
        <Col span="12">
          <Button style="margin-top:5px;margin-left:60px" type="info" @click="modifyTutorial(tutorial.id)" size="small">继续修改</Button>
          <Button style="margin-top:5px;margin-left:10px" type="info" @click="tutorialDetail(tutorial.id)" size="small">教程详情</Button>
